...
public class ReplyController {
	...
	public Result findAll(){
		return new Result(true,1000,"查询成功",replyService.findAll());
	}
	...
	public Result findById(@PathVariable String id){
		return new Result(true,1000,"查询成功",replyService.findById(id));
	}
	...
	public Result findPage(@PathVariable int page,@PathVariable int size){
		...
		return new Result(true,1000,"查询成功",new PageResult<Reply>(pageList.getTotalElements(), pageList.getContent() ) );
	}
