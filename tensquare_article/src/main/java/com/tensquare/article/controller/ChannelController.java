...
public class ChannelController {
	...
	public Result findAll(){
		return new Result(true,1000,"查询成功",channelService.findAll());
	}
	...
	public Result findById(@PathVariable String id){
		return new Result(true,1000,"查询成功",channelService.findById(id));
	}
	...
	public Result findPage(@PathVariable int page,@PathVariable int size){
		...
		return new Result(true,1000,"查询成功",new PageResult<Channel>(pageList.getTotalElements(), pageList.getContent() ) );
	}
