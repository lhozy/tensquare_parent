...
public class ColumnController {
	...
	public Result findAll(){
		return new Result(true,1000,"查询成功",columnService.findAll());
	}
	...
	public Result findById(@PathVariable String id){
		return new Result(true,1000,"查询成功",columnService.findById(id));
	}
	...
	public Result findPage(@PathVariable int page,@PathVariable int size){
		...
		return new Result(true,1000,"查询成功",new PageResult<Column>(pageList.getTotalElements(), pageList.getContent() ) );
	}
